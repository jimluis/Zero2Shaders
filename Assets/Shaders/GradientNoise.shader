    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float2 randomDir(float2 v)
            {
             ...
             {
                //integer component - grid position
                float2 i = floor(v);
                
                //float component - position witin the grid cell
                float2 f = frac(v);
            ...
            {
                //use noise as color
                //return gradientNoise(i.uv) * 0.5f + 0.5f;
                //return gradientNoise(i.uv * 45.0f) * 0.5f + 0.5f;
